          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text('Search: \"${widget.query}\"',style: TextStyle(fontWeight: FontWeight.w900,fontSize: 25)),
            ...
            Center(
              child: Container(
                ...
                child: FutureBuilder<List<UserModel>>(
                    future: DBApi.getAllUsers(widget.query),
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text('${snapshot.data![index].city}, ${snapshot.data![index].country}',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w300,fontSize: 15)),
                                            ],
                                          ),
                                        ),
                                        Padding(
